    ...
    <>
      ...
      <div className="mx-auto p-8">
        <motion.section
          ...
          animate={
            isVisible.skills ? { opacity: 1, y: 0 } : { opacity: 0, y: 100 }
          }
        ...
        <motion.section
          ...
          initial={{ opacity: 0, y: 100 }}
          animate={
            isVisible.projects ? { opacity: 1, y: 0 } : { opacity: 0, y: 100 }
          }
          transition={{ duration: 0.6, ease: "easeInOut" }}
        >
        ...
        <motion.section
          ...
          initial={{ opacity: 0, y: 100 }}
          animate={
            isVisible.contact ? { opacity: 1, y: 0 } : { opacity: 0, y: 100 }
          }
          transition={{ duration: 0.6, ease: "easeInOut" }}
        >
          <h2 className="text-[2rem] font-bold mb-4 text-center text-purple-500 mt-16 flex justify-center">
            Contact me{" "}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
