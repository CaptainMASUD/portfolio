    ...
    <div className="relative bg-gray-600 p-1 rounded-lg shadow-md h-[150px]  md:h-auto  overflow-hidden ">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-between opacity-0 bg-black bg-opacity-70 hover:opacity-100 transition-opacity duration-300">
        ...
        <div className="flex justify-between p-4">
          <a href={githubLink} target="_blank" rel="noopener noreferrer" className="text-white bg-violet-500  max-w-20 text-center p-1  rounded-md cursor-pointer">GitHub</a>
          <a href={liveDemoLink} target="_blank" rel="noopener noreferrer" className="text-white max-w-20 text-center bg-violet-500 p-1 hover:drop-shadow-lg drop-shadow-sm rounded-md cursor-pointer hover:bg-[#F2613F]">Live Link</a>
        </div>
      </div>
    </div>
  );
